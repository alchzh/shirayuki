...
export function register(manager, propName, condition) {
  ...
  Object.defineProperty(manager.prototype, propName, {
    get() {
      ...
      if (existing && !existing.deleted && predicate.call(this, existing)) return existing;

      const newID = this.cache.findKey(predicate.bind(this));
      this.registerCache.set(propName, newID);
      return newID;
    },
  });
}
